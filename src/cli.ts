...
async function listProfiles(controller: NetworkController): Promise<void> {
...
async function showProfile(controller: NetworkController, name: string): Promise<void> {
...
async function checkPid(controller: NetworkController, pid: number): Promise<void> {
...
async function runThrottling(controller: NetworkController, options: CLIOptions): Promise<void> {
  try {
